...
$.ajax({
    ...
    success : function(data){
            ...
            for(var i = 0; i < data.length; i++){
                ...
                var product_keywords = products.product_keyword;

                console.log(products);

                $("#prodDisplay .row").append('<div class="col-lg-3"> <div class="card shadow-lg" style="width: 22rem;"> <img src="'+ product_Image +'" class="card-img-top" style="height: 15rem;" alt="...">'+
