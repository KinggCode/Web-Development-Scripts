...
if(isset($_POST["brand_btn"])){
    $brandInsert = $_POST['brandQuery'];

    $checkQuery = "SELECT brand_name FROM brands WHERE brand_name = '$brandInsert'";
    ...
    if($queryCount > 0){
        ...
        if($brandInsert !== ""){
            $sql = "INSERT INTO brands(brand_name) values('$brandInsert')";
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="http://localhost/shoppn/admin/functions/addProducts.php">Users <i class="fas fa-users"></i></a>
              </li>
    ...
    <div id="BtnSec">
            <div class="row">
            <div class="col-lg-12">
                    <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#exampleModal"> Add Brand</button>
            </div>
        </div>
        </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" >
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="brandquery" name="brandQuery" placeholder="Enter Brand">
        
                </div>
            
                <button type="submit" class="btn btn-warning btn-block" name="brand_btn">Submit</button>
              </form>
      ...
      <div class="modal-footer">
        ...
        <!-- Brand Table -->
            <table id="brands_id" class="table table-hover">
