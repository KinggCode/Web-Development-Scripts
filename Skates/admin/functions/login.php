...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $adminExistQuery = "SELECT * FROM admin WHERE admin_email='$adminEmail' and admin_password='$adminPassword' and security_code='$adminCode'";
    ...
    $_SESSION['admin_firstname'] =$fetch_result[2];
    $_SESSION['admin_lastname'] =$fetch_result[3];
    $_SESSION['admin_age'] =$fetch_result[4];
    $_SESSION['admin_gender'] =$fetch_result[6];
    $_SESSION['admin_profession'] =$fetch_result[5];
    $_SESSION['admin_email'] =$fetch_result[8];
    $_SESSION['admin_address'] =$fetch_result[7];
    // $_SESSION['username'] =$fetch_result[5];
//    $_SESSION['admin_password'] =$fetch_result[6];
